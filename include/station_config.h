...
#define GMON_CFG_NUM_SOIL_SENSORS  4
#define GMON_CFG_NUM_LIGHT_SENSORS 3
#define GMON_CFG_NUM_AIR_SENSORS   2
...
#define GMON_CFG_POWER_AIRSENSORS_LATENCY_MS   32
#define GMON_CFG_POWER_LIGHTSENSORS_LATENCY_MS 42

#define GMON_CFG_ACTUATOR_NUM_PUMPS 4
#define GMON_CFG_ACTUATOR_NUM_FANS  1
