...
#define staSysMsgBoxGet(msgbuf, msg, block_time) \
    staSysCvtResp(eESPsysMboxGet((espSysMbox_t)(msgbuf), (msg), (block_time)))

#define staSysMsgBoxPut(msgbuf, msg, block_time) \
    staSysCvtResp(eESPsysMboxPut((espSysMbox_t)(msgbuf), (msg), (block_time)))
