...
#define GMON_MIN_AIR_HUMIDITY_SUPPORTED 20
    ...
    #endif
    #ifndef GMON_CFG_POWER_AIRSENSORS_LATENCY_MS
        #define GMON_CFG_POWER_AIRSENSORS_LATENCY_MS 18
    #endif
#else
    ...
    #define GMON_CFG_POWER_AIRSENSORS_LATENCY_MS      0
    ...
    #endif
    #ifndef GMON_CFG_POWER_LIGHTSENSORS_LATENCY_MS
        #define GMON_CFG_POWER_LIGHTSENSORS_LATENCY_MS 20
    #endif
#else
    ...
    #define GMON_CFG_POWER_LIGHTSENSORS_LATENCY_MS 0
...
#define GMON_LIMIT_MINNUM_SENSOR_RECORDS 2
#define GMON_LIMIT_MAXNUM_SENSOR_RECORDS 8

#ifndef GMON_CFG_NUM_SOIL_SENSOR_RECORDS_KEEP
    #define GMON_CFG_NUM_SOIL_SENSOR_RECORDS_KEEP 4
#elif (GMON_CFG_NUM_SOIL_SENSOR_RECORDS_KEEP < GMON_LIMIT_MINNUM_SENSOR_RECORDS)
    #error \
        "GMON_CFG_NUM_SOIL_SENSOR_RECORDS_KEEP shouldn't be lesser than GMON_LIMIT_MINNUM_SENSOR_RECORDS, recheck your configuration"
#elif (GMON_CFG_NUM_SOIL_SENSOR_RECORDS_KEEP > GMON_LIMIT_MAXNUM_SENSOR_RECORDS)
    #error \
        "GMON_CFG_NUM_SOIL_SENSOR_RECORDS_KEEP shouldn't be greater than GMON_LIMIT_MAXNUM_SENSOR_RECORDS, recheck your configuration"
#endif

#ifndef GMON_CFG_NUM_AIR_SENSOR_RECORDS_KEEP
    #define GMON_CFG_NUM_AIR_SENSOR_RECORDS_KEEP 4
#elif (GMON_CFG_NUM_AIR_SENSOR_RECORDS_KEEP < GMON_LIMIT_MINNUM_SENSOR_RECORDS)
    #error \
        "GMON_CFG_NUM_AIR_SENSOR_RECORDS_KEEP shouldn't be lesser than GMON_LIMIT_MINNUM_SENSOR_RECORDS, recheck your configuration"
#elif (GMON_CFG_NUM_AIR_SENSOR_RECORDS_KEEP > GMON_LIMIT_MAXNUM_SENSOR_RECORDS)
    #error \
        "GMON_CFG_NUM_AIR_SENSOR_RECORDS_KEEP shouldn't be greater than GMON_LIMIT_MAXNUM_SENSOR_RECORDS, recheck your configuration"
#endif

#ifndef GMON_CFG_NUM_LIGHT_SENSOR_RECORDS_KEEP
    #define GMON_CFG_NUM_LIGHT_SENSOR_RECORDS_KEEP 4
#elif (GMON_CFG_NUM_LIGHT_SENSOR_RECORDS_KEEP < GMON_LIMIT_MINNUM_SENSOR_RECORDS)
    #error \
        "GMON_CFG_NUM_LIGHT_SENSOR_RECORDS_KEEP shouldn't be lesser than GMON_LIMIT_MINNUM_SENSOR_RECORDS, recheck your configuration"
#elif (GMON_CFG_NUM_LIGHT_SENSOR_RECORDS_KEEP > GMON_LIMIT_MAXNUM_SENSOR_RECORDS)
    #error \
        "GMON_CFG_NUM_LIGHT_SENSOR_RECORDS_KEEP shouldn't be greater than GMON_LIMIT_MAXNUM_SENSOR_RECORDS, recheck your configuration"
#endif
...
#define GMON_DISPLAY_NUM_PRINT_STRINGS 6
