...
gMonStatus staSensorPlatformDeInitSoilMoist(void) { return GMON_RESP_OK; }
...
gMonStatus staSensorPlatformDeInitLight(void) { return GMON_RESP_OK; }
...
gMonStatus staSensorPlatformDeInitAirTemp(void) { return GMON_RESP_OK; }
