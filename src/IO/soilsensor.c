...
gMonStatus staSensorInitSoilMoist(void) { return staSensorPlatformInitSoilMoist(); }

gMonStatus staSensorDeInitSoilMoist(void) { return staSensorPlatformDeInitSoilMoist(); }
